    ...
    <div class="row">
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
            <div class="info-box">
                ...
                <div class="info-box-content">
                    <span class="info-box-text">Proposal Lolos Seleksi</span>
                    <span class="info-box-number">0</span>
                </div>
                <!-- /.info-box-content -->
            </div>
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
            <div class="info-box">
                ...
                <div class="info-box-content">
                    <span class="info-box-text">Proposal Yang Didanai</span>
                    <span class="info-box-number">0</span>
                </div>
                <!-- /.info-box-content -->
            </div>
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
            <div class="info-box">
                ...
                <div class="info-box-content">
                    <span class="info-box-text">Penelitian Lolos PIMNAS</span>
                    <span class="info-box-number">0</span>
                </div>
                <!-- /.info-box-content -->
            </div>
